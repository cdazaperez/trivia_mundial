"""FIFA World Cup 2026 – Annex C: third-place team allocation table.

Maps each of the 495 possible combinations of 8 qualifying third-place groups
to the specific R32 match slot (match number) where each third-place team plays.
Source: FIFA Competition Regulations, Annex C.
"""

# Key: sorted 8-letter string of qualifying groups (e.g. "BDEFIJKL").
# Value: dict mapping match_number -> group whose 3rd-place team fills that slot.
#   Match 74 = vs 1E, Match 77 = vs 1I, Match 79 = vs 1A, Match 80 = vs 1L,
#   Match 81 = vs 1D, Match 82 = vs 1G, Match 85 = vs 1B, Match 87 = vs 1K.


FIFA_ANNEX_C: dict[str, dict[int, str]] = {
